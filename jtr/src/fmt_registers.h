...
john_register_one(&fmt_opencl_cryptosafe);
...
john_register_one(&fmt_opencl_krb5tgs);
...
john_register_one(&fmt_opencl_oldoff);
...
john_register_one(&fmt_pdf_opencl);
